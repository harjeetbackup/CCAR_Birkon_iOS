...
@synthesize allSongsDeck = _allSongsDeck;
...
- (void) initializeAllCardDeck
{
	...
	_allCardDeck.deckTitle = @"All Blessings";
	_allCardDeck.deckType = kCardDeckTypeAll;
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        _allCardDeck.deckImage = @"1.png";
...
- (void) initializeBookMarkedCardDeck
{
	...
	_bookMarkedCardDeck.deckTitle = @"Bookmarks";
	_bookMarkedCardDeck.deckType = kCardDeckTypeBookMark;
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        _bookMarkedCardDeck.deckImage = @"11a.png";
...
- (void) initializeAllSongsDeck
{
   	_allSongsDeck = [[FlashCardDeck alloc] init];
    
    _allSongsDeck.deckId = -99;
    _allSongsDeck.deckTitle = @"All Songs";
    _allSongsDeck.deckType = kCardDeckTypeAllSongs;
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        _allSongsDeck.deckImage = @"12.png";
        
        _allSongsDeck.deckColor = [UIColor   colorWithRed:211.0/255 green:243.0/255 blue:255.0/255 alpha:1];
    }
    else{
        _allSongsDeck.deckImage = @"12.png";
        _allSongsDeck.deckColor = [Utils colorFromString:[Utils getValueForVar:kBookmarkedCardsDeckColor]];
    }
}
