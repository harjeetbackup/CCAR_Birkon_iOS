...
{	
	...
	switch(_contentType)
	{
        ...
        case kcontentTypeIntro:
            ...
            fileName = [[NSBundle mainBundle] pathForResource:@"0A1-Introduction.html" ofType:nil inDirectory:nil];
		...
		case kContentTypeInfo:
			_navItem.title = @"Info";
            fileName = [[NSBundle mainBundle] pathForResource:@"5A1-Information-tab.html" ofType:nil inDirectory:nil];
            request = [[NSURLRequest alloc] initWithURL:[NSURL fileURLWithPath:fileName]];
